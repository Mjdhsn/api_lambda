...
conditions_state = {
    ...
    "total_registered_votes_table": f"""{presidential_table_state['query']} select  constituency_name, Total_Registered_voters,Total_Accredited_voters,Total_Rejected_votes,remarks FROM  st""",
    ...
    "canceled_table": f"""{presidential_table_state['query']} SELECT constituency_name, Total_Registered_voters,Total_Accredited_voters,Total_Rejected_votes,remarks FROM  st where status ='canceled' """,
    ...
    "collated_table": f"""{presidential_table_state['query']} SELECT  constituency_name, Total_Registered_voters,Total_Accredited_voters,Total_Rejected_votes,remarks  FROM  st WHERE  (status = 'collated' OR status='canceled')""",
    ...
    "un_collated_table":f"""{presidential_table_state['query']} SELECT  constituency_name, Total_Registered_voters,Total_Accredited_voters,Total_Rejected_votes,remarks FROM  st where status='non collated'""",
