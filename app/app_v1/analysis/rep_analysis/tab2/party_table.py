...
ct AS
       ...
       AS percentage_voters_turnout 
       	...
       	win AS
         (SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, A AS votes, 'A' AS party FROM pu 
          UNION 
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, AA AS votes, 'AA' AS party FROM pu
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, ADP AS votes, 'ADP' AS party FROM pu
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, APP AS votes, 'APP' AS party FROM pu
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, AAC AS votes, 'AAC' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, ADC AS votes, 'ADC' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, APC AS votes, 'APC' AS party FROM pu  
          UNION 
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, APGA AS votes, 'APGA' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, APM AS votes, 'APM' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, BP AS votes, 'BP' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, LP AS votes, 'LP' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, NRM AS votes, 'NRM' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, NNPP AS votes, 'NNPP' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, PDP AS votes, 'PDP' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, PRP AS votes, 'PRP' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, SDP AS votes, 'SDP' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, YPP AS votes, 'YPP' AS party FROM pu  
          UNION
          SELECT state_id, lga_id, ward_id, state_name,lga_name,ward_name,pu_id,pu_code, pu_name,Total_Registered_voters,total_vote_casted,Total_Accredited_voters,over_vote_values,remarks,total_valid_votes, ZLP AS votes, 'ZLP' AS party FROM pu ),
...
win_pu AS
           (SELECT state_id, lga_id, ward_id,state_name,lga_name, ward_name,pu_id,pu_code,pu_name, votes, Total_Registered_voters,Total_Accredited_voters,
...
collated_ward AS 
			(SELECT distinct ward_id,state_id,lga_id,state_name,lga_name, ward_name,sum(Total_Registered_voters) OVER(PARTITION BY state_id,lga_id, ward_id) AS Total_Registered_voters,
			sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id, ward_id) AS total,
			(sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id, ward_id) - 
			sum(case when status = 'collated' OR status = 'canceled' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id, ward_id)) AS deef FROM pu),
					
			
collated_lga AS
			(SELECT distinct lga_id,state_id,state_name,lga_name, sum(Total_Registered_voters) OVER(PARTITION BY state_id,lga_id) AS Total_Registered_voters,
			sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id) AS total,
			(sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id) -
			sum(case when status = 'collated' OR status = 'canceled' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id)) AS deef FROM pu),
			
collated_state AS
			(SELECT distinct state_id,state_name, sum(Total_Registered_voters) OVER(PARTITION BY state_id) AS Total_Registered_voters,
			sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id) AS total,
			(sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id))-
			(sum(case when status = 'collated' OR status = 'canceled'  then 1 else  0 end) OVER(PARTITION BY state_id)) AS deef FROM pu),
	
state_25_above AS 
			(select party, count(state_name) count1  from win_s where total_vote_casted>0 AND votes/total_vote_casted*100>25 
...
exp_winner  AS
			(select party,votes,count1,COALESCE (votes-lead(votes,1) over (ORDER BY votes desc),0) as diff FROM diff_bw_1st_2nd) 	
...
collated_ward AS 
			...
			sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id, ward_id) AS total,
			(sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id, ward_id) - 
			sum(case when status = 'collated' OR status = 'canceled' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id, ward_id)) AS deef FROM wt),
...
collated_lga AS
			...
			sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id) AS total,
			(sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id) -
			sum(case when status = 'collated' OR status = 'canceled' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id)) AS deef FROM wt),
			
collated_state AS
			(SELECT distinct state_id,state_name, sum(Total_Registered_voters) OVER(PARTITION BY state_id) AS Total_Registered_voters,
			sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id) AS total,
			(sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id))-
			(sum(case when status = 'collated' OR status = 'canceled'  then 1 else  0 end) OVER(PARTITION BY state_id)) AS deef FROM wt),
...
collated_lga AS
			...
			sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id) AS total,
			(sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id) -
			sum(case when status = 'collated' OR status = 'canceled' then 1 else  0 end) OVER(PARTITION BY state_id,lga_id)) AS deef FROM lgat),
			
collated_state AS
			(SELECT distinct state_id,state_name, sum(Total_Registered_voters) OVER(PARTITION BY state_id) AS Total_Registered_voters,
			sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id) AS total,
			(sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id))-
			(sum(case when status = 'collated' OR status = 'canceled'  then 1 else  0 end) OVER(PARTITION BY state_id)) AS deef FROM lgat),
...
collated_state AS
			...
			sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id) AS total,
			(sum(case when status = 'collated' OR status = 'canceled' OR status = 'non collated' then 1 else  0 end) OVER(PARTITION BY state_id))-
			(sum(case when status = 'collated' OR status = 'canceled'  then 1 else  0 end) OVER(PARTITION BY state_id)) AS deef FROM st),
